...
<link href="idea2/estilo.css" rel="stylesheet"  />
<script src="http://code.jquery.com/jquery-latest.js"></script>
<script src="idea2/header.js"></script> 
...
<body>
	...
	<header class="header">
		<div class="wrapper1">
			...
			<nav>
				...
				<a id="inicio" href="#">Inicio sesion</a>
			</nav>
		</div>
	</header>
	...
	<div align="center"><iframe src="../acordeon/acordeon.html" width=99% height=500 frameborder=1 
    style="border:solid #003b4a 2px; margin-bottom:5%;"></iframe></div>
